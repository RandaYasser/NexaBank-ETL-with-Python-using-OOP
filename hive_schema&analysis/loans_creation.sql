...
CREATE EXTERNAL TABLE tmp_loans (
    customer_id STRING,
    loan_type STRING,
    amount_utilized INT,
...
STORED AS PARQUET
LOCATION '/user/hive/warehouse/nexabank.db/loans';
...
STORED AS PARQUET
LOCATION '/user/hive/warehouse/nexabank.db/loans_final'
TBLPROPERTIES (
...
SELECT 
    ...
    loan_type,
    amount_utilized,
    CAST(utilization_date AS TIMESTAMP) AS utilization_date,
    loan_reason,
    age,
    total_cost,
